# loaded_functions.py
import pickle
from functions import extract_keywords_with_rake,extract_text_from_pdf, extract_keywords_from_text, clean_keywords, extract_text_from_doc, extract_text_from_image
...
with open('keyword_extraction.pkl', 'rb') as file:
    ...
    loaded_extract_keywords_with_rake = extract_keywords_with_rake
